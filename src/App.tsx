...
export default function App() {
  ...
  return (
    <div className="h-screen overflow-hidden bg-[#dcdcdc] p-1.5 sm:p-2">
      <div className="mx-auto flex h-full max-w-[1820px] gap-3">
        ...
        <section className="flex min-w-0 flex-1 flex-col gap-3">
          <header className="flex h-[64px] items-center justify-between rounded-[20px] border border-[#ececec] bg-white px-3 shadow-sm sm:h-[72px] sm:px-5 lg:rounded-[24px] lg:px-8">
            ...
            <div className="flex items-center gap-2 sm:gap-3 lg:gap-4">
              ...
              <div className="relative">
                <button className="flex h-9 w-9 items-center justify-center rounded-full bg-white text-[#2d2f32] shadow-sm transition-all duration-200 hover:-translate-y-0.5 hover:bg-[#f0f0f0] hover:shadow-[0_4px_12px_rgba(0,0,0,0.15)] active:scale-90 sm:h-10 sm:w-10"><BellIcon className="h-5.5 w-5.5 sm:h-6 sm:w-6" /></button>
              ...
              {isSignedIn ? (
                ...
                <div className="flex items-center gap-2">
                  <button onClick={() => openAuthModal("login")} className="rounded-full border border-[#d4d6db] bg-white px-3 py-1.5 text-[13px] font-medium text-[#303030] shadow-sm transition-all duration-200 hover:-translate-y-0.5 hover:bg-[#f5f6f7] hover:shadow-[0_4px_14px_rgba(0,0,0,0.1)] active:scale-[0.97] sm:px-4 sm:py-2 sm:text-sm">Sign In</button>
                  <button onClick={() => openAuthModal("signup")} className="rounded-full bg-[#303030] px-3 py-1.5 text-[13px] font-medium text-white shadow-[0_4px_14px_rgba(0,0,0,0.25)] transition-all duration-200 hover:-translate-y-0.5 hover:bg-[#1f1f1f] hover:shadow-[0_6px_20px_rgba(0,0,0,0.35)] active:scale-[0.97] sm:px-4 sm:py-2 sm:text-sm">Sign Up</button>
                </div>
              )}
              <button onClick={() => setMenuOpen(true)} className="rounded-full bg-[#f7f7f7] p-2 text-[#2f3135] shadow-sm transition-all duration-200 hover:bg-[#efefef] hover:shadow-[0_4px_12px_rgba(0,0,0,0.08)] active:scale-95 lg:hidden sm:p-2.5"><MenuIcon className="h-6 w-6" />
              </button>
            </div>
          </header>
